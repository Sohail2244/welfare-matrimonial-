      ...
      <div class="row">
        ...
        <div class="col-lg-6 p-0 login-form-section">
          ...
          <div class="login-section">
            ...
            <p>This Privacy Policy describes how Welfare Matrimonial ("we," "us," or "our") collects, uses, and shares
              your personal information when you use our website and services. By accessing or using Welfare
              Matrimonial, you agree to the terms outlined in this Privacy Policy.</p>
            <p> When you register, you willingly provide details such as your name, email address, and date of birth,
              while our optional profile features allow you to share preferences, interests, and photographs.
              Communication data, including messages and chats, is collected to enhance your experience on our platform.
            </p>
            <p> We utilize this information for personalized matchmaking, recommending potential matches based on your
              profile and preferences. To facilitate connections, certain details may be shared with other users
              expressing mutual interest. Additionally, for service improvement, we may engage third-party providers
              while adhering to legal requirements. Your data security is our concern, and we implement measures to
              protect against unauthorized access. Users maintain control over profile visibility and communication
              preferences, ensuring a tailored and secure experience.</p>
          </div>
        </div>
      </div>
    </div>
