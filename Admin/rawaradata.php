...
$q = "SELECT * FROM `rawara_profile` ORDER BY ID DESC";
...
while ($row = mysqli_fetch_array($querry)) {
    $html .= '<tr>
        ...
        <td><button class="btn "style="background-color:#9b2c47;"><a href="editrawara.php?updateid=' . $row['ID'] . '" style=" color:white">Edit</a></button></td>
    </tr>';
}
if (isset($_GET['deleteid'])) {
    ...
    $sql = "DELETE FROM `rawara_profile` WHERE  ID='$id' ";
...
<script>
    function confirmDelete(userId) {
        if (confirm("Are you sure you want to delete this user?")) {
            window.location.href = "rawaradata.php?deleteid=" + userId;
        }
    }
</script>
<body>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand  navbar-light sticky-top px-4 py-0">
                ...
                <form class="d-none d-md-flex ms-4">
                    <input class="form-control border-0" type="text" id="searchInput" placeholder="Search by name" autocomplete="off">
                </form>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Rawara Profile Data Table</h6>
