            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Rawara Profile Table</h6>
                            <a href="./rawaradata.php">Show All</a>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
<?php $query_profiles = mysqli_query($conn, "SELECT * FROM `rawara_profile` ORDER BY ID DESC") or die(mysqli_error($conn));
...
?>
                    ...
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">User Profile Table</h6>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
<?php $query_profiles = mysqli_query($conn, "SELECT * FROM `contactus` ORDER BY ID DESC") or die(mysqli_error($conn));
...
while ($profile = mysqli_fetch_array($query_profiles)) {
    ?>
                                <tr>
                                    ...
                                    <td><?php echo $profile['email']; ?></td>
                                    <td><?php echo $profile['phone']; ?></td>
                                    <td><?php echo $profile['reason']; ?></td>
                                    <td><?php echo $profile['message']; ?></td>
                                    <td><?php echo date('F j, Y, g:i a', strtotime($profile['timestamp'])); ?></td>
