...
$q = "SELECT * FROM `weddingprof` ORDER BY ID DESC";
...
while ($row = mysqli_fetch_array($querry)) {
    $html .= '<tr>
        ...
        <td><button class="btn" style="background-color:#9b2c47;" ><a href="./edituserprofile.php?updateid=' . $row['ID'] . '" style=" color:white">Edit</a></button></td>
...
<script>
    function confirmDelete(userId) {
        if (confirm("Are you sure you want to delete this user?")) {
            window.location.href = "deleteuserprofile.php?deleteid=" + userId;
        }
    }
</script>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">User Profiles Table</h6>
