            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link text-white" data-bs-toggle="dropdown" href="index.php">Profile
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="#" tabindex="-1" aria-disabled="true">Donor</a>
                </li>

                <li class="nav-item">
                  <a class="nav-link text-white" href="signup.php" tabindex="-1" aria-disabled="true">Sign Up</a>
                </li>
                <li class="nav-item">
