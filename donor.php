      ...
      <div class="col-lg-6 p-0">
                    <div class="login-image-section3">
                        <div class="image-section-content3">
                            <h2>You Can also Donate with</h2>
                            <p>Changing lives, one donation at a time.</p>
                            <div class="sideflex">
                                <div class="button">
                                    <img src="./images/jazzcash.png" alt="">
                                </div>
                                <div class="sideflexp">
                            ...
                            <div class="sideflex">
                                <div class="button">
                                    <img src="./images/Easypaisa-New-Icon-Logo-Small.png" alt="">
                                </div>
                                <div class="sideflexp">
        ...
        <div class="col-lg-6 p-0 login-form-section">
          ...
          <div class="login-section">
            ...
            <form action="#" method="">
              <div class="mb-4">
                <input type="text" name="cnumber" class="form-control" placeholder="Enter Card Number" value="" />
              </div>
              <div class="mb-4">
                <input type="text" name="cdate" class="form-control" placeholder="Enter Card Date " />
              </div>
              <div class="mb-4">
                <input type="text" name="scode" class="form-control" placeholder="Security Code" value="" />
              </div>
              <div class="mb-4">
                <input type="text" name="cname" class="form-control" placeholder="Enter Card Full Name" />
              </div>
