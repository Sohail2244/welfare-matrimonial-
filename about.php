      ...
      <div class="row">
        ...
        <div class="col-lg-6 p-0 login-form-section">
          ...
          <div class="login-section">
            <h4>About Us</h4>
            <p>Welcome to Welfare Matrimonial, where we believe in uniting hearts and fostering lifelong connections.
              Our dedicated team is committed to creating a platform that goes beyond the conventional boundaries of
              matrimony. We understand that finding a life partner is a significant journey, and we are here to make it
              meaningful and memorable for you.</p><br>
            <p>At Welfare Matrimonial, we take pride in our mission to bring together individuals who are not just
              seeking a life partner but are also committed to building a shared future based on love, respect, and
              understanding. Our platform is designed to cater to the diverse needs of our community, ensuring a
              seamless and enriching experience for all.</p>
          </div>
        </div>
      </div>
    </div>
