        ...
        <div class="container main-login-section">
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="login-image-section2">
                ...
                <div class="col-lg-6 p-0 login-form-section">
                    ...
                    <div class="login-section">
                        ...
                        <p>Please read these terms and conditions carefully before using Welfare Matrimonial. By
                            accessing or using our services, you agree to comply with and be bound by these terms. If
                            you do not agree with any part of these terms, please do not use our services.</p>
                        <p>At Welfare Matrimonial, adherence to a set of principles ensures a secure and respectful
                            environment for our users. Eligibility mandates that individuals registering on our platform
                            be at least 18 years old, confirming their legal capacity for a binding contract. Users are
                            responsible for the accuracy of information provided during registration and maintaining the
                            confidentiality of their account credentials. Upholding a code of conduct, users agree to
                            comply with laws, refrain from harassment or discrimination, and avoid any unlawful
                            activities on the platform.</p>
                        <p> Content guidelines emphasize user responsibility for posted content, prohibiting offensive
                            or defamatory materials, with Welfare Matrimonial reserving the right to remove violative
                            content. Privacy and security are paramount, with user data handled in accordance with our
                            Privacy Policy, and users responsible for safeguarding their personal information. Welfare
                            Matrimonial may terminate or suspend accounts for violations, and users can terminate
                            accounts at any time. </p>
