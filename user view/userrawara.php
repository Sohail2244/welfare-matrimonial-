            ...
            <div class="col-md-12 p-0">
                <nav class="navbar navbar-expand-lg navbar-light navbar-bg bg-dark p-0">
                    <div class="container-fluid navabar-logo">
                        ...
                        <a class="navbar-brand text-white" href="userindex.php">
                            <span>WELFARE</span> MATRIMONIAL</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a class="nav-link active text-white" aria-current="page" href="userindex.php">Home</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row ">
                ...
                <div class="col-md-12 testimonials-heading">
                    <div class="titletesttimonial">
                        <h2>Rawara Profiles</h2>
                    </div>
                    <div class="col-md-6" style="margin-top:50px">
                        <form class="d-none d-md-flex ms-4">
                            <input class="form-control border-1" type="text" id="searchInput" placeholder="Search by name" autocomplete="off">
                        </form>
                    </div>
                </div>
            </div>
...
$query_rawara = mysqli_query($conn, "SELECT * FROM `rawara_profile` ORDER BY ID DESC") or die(mysqli_error($conn));

// Loop through the feedback and display each item
while ($rawara = mysqli_fetch_array($query_rawara)) {
?>
                    ...
                    <div class="col-12 col-md-6 mb-5">
                        <div class="media mediaimg media-wrapper d-flex" style="align-items: normal!important; background-color: #fff; border-radius: 10px; min-height: 300px; box-shadow: -6px -7px 48px -12px rgba(222,219,222,1);">
                            <!-- <div class="media-img"> -->
                            <img src="../upload/<?php echo $rawara['email']; ?>/<?php echo $rawara['profile_image']; ?>" alt="Image" class="me-3" />
                            <!-- </div> -->

                            <div class="media-body  m-3 d-flex">
                                <p>
                                    <strong>
                                        <?php echo  "Name: " .$rawara['username']; ?>
                                    </strong>
                                    <br>
                                    <br>
                                    <?php echo "<strong>Email: </strong>". $rawara['email']; ?>
                                    <br>
                                    <?php echo "<strong>Contact: </strong>".$rawara['contact']; ?>
                                    <br>
                                    <?php echo "<strong>Age: </strong>".$rawara['age']; ?>
                                    <br>
                                    <?php echo "<strong>Gender: </strong>".$rawara['gender']; ?>
                                    <br>
                                    <?php echo "<strong>Status: </strong>".$rawara['status']; ?>
                                    <br>
                                    <?php echo "<strong>Country: </strong>".$rawara['country']; ?>
                                    <br>
                                    <?php echo "<strong>Eductaion: </strong>".$rawara['education']; ?>
                                    <br>
                                    <?php echo "<strong>Caste: </strong>".$rawara['caste']; ?>
                                    <br>
                                    <?php echo "<strong>Religion: </strong>".$rawara['religion']; ?>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                var profileItems = document.querySelectorAll('.testimonial-row .col-12');

                profileItems.forEach(function(item) {
                    var name = item.querySelector('.media-body strong:first-of-type').textContent
                        .toLowerCase();
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <h1>
                        <span>WELFARE</span>MATRIMONIAL</h1>
                    <p>
                        Find Your Perfect Match.
                        <br> Love Online Totally Free Matrimonial Platform.
                    </p>
