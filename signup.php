...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($result_check_email->num_rows > 1) {
            ...
            $sql = "INSERT INTO signup (first_name, last_name, email, password, Cpassword, gender, date_of_birth, marital_status,
            country_id, state_id, city_id, caste_id, religion_id, education_id, phone,token)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
            ...
            if ($stmt) {
                // Bind parameters
                $stmt->bind_param("ssssssssssssssss", $first_name, $last_name, $email, $password, $password_confirmation, $gender, $date_of_birth,
                    $marital_status, $country_id, $state_id, $city_id, $caste_id, $religion_id, $education_id, $phone, $token);
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    header("Location: signup.php?success=Thank you for registering! You can now log in.");
                    exit();
                } else {
...
?>
            ...
            <form class="row g-4" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" >
              ...
              <div class="col-md-6">
                <input name="email" class="form-control" placeholder="Email" value="" autocomplete="off" />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
              <select name="country_id" id="city_id" class="form-select" style="width: 100%">
              ...
              <div class="col-md-6">
              <select name="city_id" id="city_id" class="form-select" style="width: 100%">
              ...
              <div class="col-md-6">
                <select name="caste_id" id="#" class="form-select" style="width: 100%">
              ...
              <div class="col-md-6">
              <select name="religion_id" id="religion_id" class="form-select" style="width: 100%">
              ...
              <div class="col-md-6">
              <select name="education_id" id="education_id" class="form-select" style="width: 100%">
